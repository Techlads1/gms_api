...
CREATE TABLE IF NOT EXISTS grievance_resolution
             (
                          id   SERIAL,
...
CREATE TABLE IF NOT EXISTS grievance_resolution_state
             (
                          id   SERIAL,
                          name VARCHAR (200) NULL,
                          description TEXT NULL,
                          ...
                          updated_at timestamp (0) NULL,
                          PRIMARY KEY (id)
CREATE TABLE IF NOT EXISTS grievance_time_extension
             (
                          id   SERIAL,
                          grievance_id  INT not null,
                          gfu_id INT not null,
...
CREATE TABLE IF NOT EXISTS grievance_forward
             (
                          id   SERIAL,
                          grievance_id INT not null,
                          state TEXT NULL,
                          fromgfu_id INT not null,
                          togfu_id INT not null,
                          description TEXT NULL,
                          comment TEXT not null,
                          created_at timestamp (0) NULL,
                          updated_at timestamp (0) NULL,
